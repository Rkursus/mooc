...
andmed2 <- read.table("https://github.com/Rkursus/2020/raw/master/data/tulemused.txt",
                         header = T, sep = "\\", dec = ",")
andmed2
...
#download.file("https://github.com/Rkursus/2020/raw/master/data/A.csv", "A.csv",  mode = "wb")
...
download.file("https://github.com/Rkursus/2020/raw/master/data/B.csv", 
              "B.csv", mode = "wb")
...
pojad <- read.table("https://github.com/Rkursus/2020/raw/master/data/pojad.txt", 
                    header = T)
pojad
...
kapsad <- read.table("https://github.com/Rkursus/2020/raw/master/data/cabbages.txt", 
                     header = T)
...
dieet <- read.csv2("https://github.com/Rkursus/2020/raw/master/data/dieet.csv", header = T)
