...
- **Ülesanne 1** Vali õige vastusevariant, kuidas muutub histogrammi värv? Omista muutujale `vastus` vastav number.
...
- Keskmise arvutamise funktsioon (`mean`) tuleb `stat_summary()` käsus anda `fun` väärtuseks.
