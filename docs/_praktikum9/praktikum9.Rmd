...
# Programmeerimine R-is ja simuleerimine

R on [programmeerimiskeele S](http://en.wikipedia.org/wiki/S_(programming_language)) implementatsioon; selles on olemas enamus teistest programmeerimiskeeltest tuttavaid konstruktsioone nagu tsüklid, `if-else` tingimuslaused ning võimalus kirjutada lisafunktsioone. Tutvume nendega lähemalt.
