...
Teeme tutvust `r  icon::fa_r_project()`-ga, vaatame mis see R on, käime üle R-i süntaksi olulisemad nüansid ja paneme R-i meie jaoks tööle.
...
```{r arvutusTest, exercise = TRUE, eval = F}
4 * 6
