...
Nüüd kus andmetüübid ja andmestiku sisselugemine on selged, vaatame kuidas saame andmeid manipuleerida, sest tihti on meil vaja ainult kindlaid tunnuseid või kindlaid vaatlusi. Lisaks vaatame kuidas andmetest esmast vajalikku teavet eraldada.


## Andmete eraldamine indeksi ja nime järgi
...
## Andmete eraldamine tõeväärtusvektori abil
...
#5
table(andmed$SCHL %in% c("Doctorate degree", "main's degree","Bachelor's degree"))
...
# ERi tulemused!!!!!
ilma <- !(andmed$SCHL %in% c("Doctorate degree", "main's degree","Bachelor's degree", "Professional degree beyond a bachelor's degree"))
ilma <- !(andmed$SCHL == "Doctorate degree" | andmed$SCHL == "main's degree"| andmed$SCHL =="Bachelor's degree" | andmed$SCHL == "Professional degree beyond a bachelor's degree")
